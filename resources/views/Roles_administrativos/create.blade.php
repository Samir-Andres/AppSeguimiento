...
@section('content_header')
    ...
    <div class="flex flex-wrap items-center space-x-2 text-sm text-gray-500 font-medium">
        ...
        <a class="text-indigo-500">Crear rol</a>
...
@section('content')
    ...
    <form action="{{route('Rolesadministrativos.store')}}" method="POST" id="main-form" style="display: none;" class="flex flex-col items-center text-sm text-slate-800 p-6 bg-white shadow-xl rounded-2xl border border-slate-100">
        ...
        <h1 class="text-4xl font-bold py-4 text-center">Crear rol</h1>
        ...
        <div class="max-w-96 w-full px-4">
            ...
            <textarea name="descripcion" rows="4"
                      ...
                      placeholder="Ejem: Encargado de administrar">{{ old('descripcion') }}</textarea>
