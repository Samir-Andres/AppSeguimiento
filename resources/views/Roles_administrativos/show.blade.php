...
@section('content_header')
    ...
    <div class="flex flex-wrap  items-center space-x-2 text-sm text-gray-500 font-medium">
        ...
        <a class="text-indigo-500">Detalle del rol</a>
...
@section('content')
    <div class="flex flex-col items-center pt-10 px-4">
        ...
        <div class="w-full max-w-md bg-white border border-gray-200 rounded-lg shadow-sm">
            ...
            <div class="p-8">
                <div class="mb-6">
                    <label class="block text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-1">Nombre del rol</label>
                    <p class="text-gray-500 text-sm leading-relaxed">{{ $rol->nombre }}</p>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4 pt-4 border-t border-gray-100">
                    <div>
                        <label class="block text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-1">ID
                            Registro</label>
                        <p class="text-sm font-mono text-gray-500">{{ $rol->NIS }}</p>
                    </div>
                    <div>
