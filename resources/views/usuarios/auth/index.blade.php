...
@section('title', 'Centro de usuarios')
...
@section('content_header')
    ...
    <div class="flex flex-wrap  items-center space-x-2 text-sm text-gray-500 font-medium">
        ...
        <a class="text-indigo-500">Usuarios</a>
    ...
    <div class="relative isolate flex items-center gap-x-6 overflow-hidden  px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
        ...
        <div class="flex flex-wrap items-center gap-x-4 gap-y-2">
            <p class="text-sm/6 text-gray-900">
                <strong class="font-semibold uppercase">Centro de registro </strong>Puedes registrar usuarios
            </p>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm text-left text-gray-500">
                ...
                <tr>
                    ...
                    <th scope="col" class="px-6 py-3">Email verificado</th>
                    <th scope="col" class="px-6 py-3">Rol administrativo</th>
                ...
                @forelse ($usuarios as $item)
                    ...
                    <td class="px-6 py-3 whitespace-nowrap">
                            ...
                            <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">Verificado</span>
                             @else
                            <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-red-200 text-black">Sin verificar</span>
                        @endif

                        </td>

                        <td class="px-6 py-3 whitespace-nowrap">
                            <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800"> {{ $item->roles->nombre }}</span>
