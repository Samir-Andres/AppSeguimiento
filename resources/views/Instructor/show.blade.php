...
@section('content_header')
    ...
    <div class="flex flex-wrap  items-center space-x-2 text-sm text-gray-500 font-medium">
        ...
        <a href="{{ route('Instructores.index') }}">Instructor</a>
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                d="m14.413 10.663-6.25 6.25a.939.939 0 1 1-1.328-1.328L12.42 10 6.836 4.413a.939.939 0 1 1 1.328-1.328l6.25 6.25a.94.94 0 0 1-.001 1.328"
                fill="#CBD5E1" />
        </svg>
        <a class="text-indigo-500">Detalle del instructor</a>
...
@section('content')
    ...
    <div class="flex flex-col items-center pt-10 px-2">
        ...
        <div class="w-full max-w-xl bg-white border border-gray-200 rounded-lg shadow-sm">
            <div class="p-4">
                <h3 class="text-center mb-3">Registro del instructor <span class="uppercase">{{$instructor->Nombres}}</span> </h3>
                <hr class="mb-3">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
                    <div class="mb-1">
                        ...
                        <p class="text-gray-600 text-sm leading-relaxed">
                            {{$instructor->tipo_documentos->Denominacion}}
                        </p>
                    </div>
                ...
                <div class="grid grid-cols-1 gap-4 pt-4 border-t border-gray-100">
                    <div class="mb-6">
                        ...
                        <p class="text-sm font-mono text-gray-500">{{ $instructor->NIS }}</p>
                    </div>
                </div>
            ...
            <span class="text-xs text-gray-500 break-all w-full md:w-auto text-left">
                ...
                <span class="text-blue-600">{{$instructor->Correo_Personal}}</span>
            </span>
                    <a href="{{ route('Instructores.index') }}" class="text-xs font-semibold text-blue-600 hover:underline shrink-0">
                        Regresar
                    </a>
                </div>
            </div>
