...
@section('content_header')
    ...
    <div class="flex flex-wrap  items-center space-x-2 text-sm text-gray-500 font-medium">
        ...
        <a class="text-indigo-500">Instructores</a>
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                d="m14.413 10.663-6.25 6.25a.939.939 0 1 1-1.328-1.328L12.42 10 6.836 4.413a.939.939 0 1 1 1.328-1.328l6.25 6.25a.94.94 0 0 1-.001 1.328"
                fill="#CBD5E1" />
    ...
    <div class="relative isolate flex items-center gap-x-6 overflow-hidden px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
        ...
        <div class="flex items-center gap-x-4">
            <div class="text-sm text-gray-900 text-justify md:text-left leading-relaxed">
                <strong class="font-semibold uppercase">Bienvenidos al centro de Instructores,</strong>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm text-left text-gray-500" id="tabla_alternativas">
                ...
                <tr>
                    ...
                    <th scope="col" class="px-6 py-3">T. Documentos</th>
                ...
                @forelse ($instructores as $item)
                    <tr class="bg-white border-b hover:bg-gray-50">
                        ...
                        <td class="px-6 py-3 whitespace-nowrap">
                           @if($item->tbl_tipo_documentos_NIS == 1)
                               TI
                            @elseif($item->tbl_tipo_documentos_NIS == 2)
                               CC
                            @elseif($item->tbl_tipo_documentos_NIS == 3)
                               CE
                            @else
                               Otro
                           @endif
                        ...
                        <td class="px-6 py-3 whitespace-nowrap">
                            <span class="text-gray-900 font-medium">{{$item->Numdoc}}</span>
                        </td>


                        <td class="px-6 py-3 whitespace-nowrap">
                            <span class="text-gray-900 font-medium">{{$item->Nombres}}</span>
                        </td>

                        <td class="px-6 py-3 whitespace-nowrap">
                            <span class="text-gray-900 font-medium">{{$item->Apellidos}}</span>
                        </td>
                        ...
                        <td class="px-6 py-3 whitespace-nowrap">
                            <span class="text-gray-900 font-medium">{{$item->Correo_Personal}}</span>
                        </td>
                        ...
                        <td class="px-10 py-3">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right shadow-lg border-0 p-2">
                                    ...
                                    <a href="{{route('Instructores.show', $item->NIS)}}"
                                    ...
                                    <a href="{{route('Instructores.edit', $item->NIS)}}"
                                    ...
                                    <form action="{{route('Instructores.destroy', $item->NIS)}}" method="POST"
                                          class="form-eliminar">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
