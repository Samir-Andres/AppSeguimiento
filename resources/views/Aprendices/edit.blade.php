...
@section('content_header')
    <div class="flex flex-wrap  items-center space-x-2 text-sm text-gray-500 font-medium ">
        ...
        <a class="text-indigo-500">Actualizar aprendiz</a>
...
@section('content')
    ...
    <section class="flex items-center justify-center py-3 px-4 ">
                ...
                <form method="POST" action="{{route('Aprendices.update', $aprendices->NIS)}}">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-1">
                            ...
                            <select name="tbl_tipo_documentos_NIS" class="w-full px-3 py-2.5 border border-gray-200 rounded-xl text-sm outline-none bg-white focus:border-indigo-500 transition-colors text-gray-500">
                                ...
                                @foreach ($documento as $item)
                                    <option value="{{ $item->NIS }}"
                                        {{ $item->NIS == $aprendices->tbl_tipo_documentos_NIS ? 'selected' : '' }}>
                                        {{ $item->Denominacion }}
                                    </option>
                        ...
                        <div>
                            ...
                            <input type="text" name="Numdoc" placeholder="1029..." class="w-full px-3 py-2.5 border border-gray-200 rounded-xl text-sm outline-none focus:border-indigo-500 transition-colors" value="{{ old('Numdoc', $aprendices->Numdoc) }}" />
                            @error('Numdoc')
                            <p class="text-red-500 text-xs mb-0 pl-2 text-center">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="Nombres" placeholder="Juan" class="w-full px-3 py-2.5 border border-gray-200 rounded-xl text-sm outline-none focus:border-indigo-500 transition-colors" value="{{ old('Nombres',$aprendices->Nombres ) }}" />
                            @error('Nombres')
                            <p class="text-red-500 text-xs mb-0 pl-2 text-center">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="Apellidos" placeholder="Pérez" class="w-full px-3 py-2.5 border border-gray-200 rounded-xl text-sm outline-none focus:border-indigo-500 transition-colors" value="{{ old('Apellidos', $aprendices->Apellidos) }}" />
                            @error('Apellidos')
                            <p class="text-red-500 text-xs mb-0 pl-2 text-center">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div >
                            ...
                            <input type="text" name="Direccion" placeholder="Calle 123..." class="w-full px-3 py-2.5 border border-gray-200 rounded-xl text-sm outline-none focus:border-indigo-500 transition-colors" value="{{ old('Direccion', $aprendices->Direccion) }}" />
                            @error('Direccion')
                            <p class="text-red-500 text-xs mb-0 pl-2 text-center">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="Telefono" placeholder="300..." class="w-full px-3 py-2.5 border border-gray-200 rounded-xl text-sm outline-none focus:border-indigo-500 transition-colors" value="{{ old('Telefono', $aprendices->Telefono) }}" />
                            @error('Telefono')
                            <p class="text-red-500 text-xs mb-0 pl-2 text-center">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="date" name="FechaNac" class="w-full px-3 py-2.5 border border-gray-200 rounded-xl text-sm outline-none focus:border-indigo-500 transition-colors text-gray-500" value="{{ old('FechaNac', $aprendices->FechaNac) }}" />
                            @error('FechaNac')
                            <p class="text-red-500 text-xs mb-0 pl-2 text-center">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="email" name="Correo_Institucional" placeholder="@misena.edu.co" class="w-full px-3 py-2.5 border border-gray-200 rounded-xl text-sm outline-none focus:border-indigo-500 transition-colors" value="{{ old('Correo_Institucional', $aprendices->Correo_Institucional) }}" />
                        ...
                        <div>
                            ...
                            <input type="email" name="Correo_Personal" placeholder="@gmail.com" class="w-full px-3 py-2.5 border border-gray-200 rounded-xl text-sm outline-none focus:border-indigo-500 transition-colors" value="{{ old('Correo_Personal', $aprendices->Correo_Personal) }}" />
                        ...
                        <div>
                            ...
                            <select name="Sexo" class="w-full px-3 py-2.5 border border-gray-200 rounded-xl text-sm outline-none bg-white focus:border-indigo-500 transition-colors text-gray-500">
                                ...
                                <option value="0" @selected(old('Sexo', $aprendices->Sexo) == '0')>
                                    Femenino
                                </option>
                                <option value="1" @selected(old('Sexo', $aprendices->Sexo) == '1')>
                                    Masculino
                                </option>
                        ...
                        <div>
                            ...
                            <select name="tbl_eps_NIS" class="w-full px-3 py-2.5 border border-gray-200 rounded-xl text-sm outline-none bg-white focus:border-indigo-500 transition-colors text-gray-500">
                                ...
                                @foreach ($eps as $item)
                                   <option value="{{ $item->NIS }}"
                                        {{ $item->NIS == $aprendices->tbl_eps_NIS ? 'selected' : '' }}>
                                        {{ $item->Denominacion }}
                                    </option>
                        ...
                        <div>
                            ...
                            <select name="tbl_ficha_caracterizacion_NIS" class="w-full px-3 py-2.5 border border-gray-200 rounded-xl text-sm outline-none bg-white focus:border-indigo-500 transition-colors text-gray-500">
                                ...
                                @foreach ($ficha as $item)
                                    <option value="{{ $item->NIS }}"
                                        {{ $item->NIS == $aprendices->tbl_ficha_caracterizacion_NIS ? 'selected' : '' }}>
                                        {{ $item->Denominacion }}
                                    </option>
                                @endforeach
                            ...
                            <button type="submit"
                                    class="flex items-center justify-center gap-2 mt-1 bg-indigo-500 hover:bg-indigo-600 text-white py-2.5 w-full rounded-full transition shadow-lg shadow-indigo-200">
                                Crear Registro
