...
@section('content_header')
    ...
    <div class="flex flex-wrap  items-center space-x-2 text-sm text-gray-500 font-medium">
        ...
        <a class="text-indigo-500">Detalle de la eps</a>
        ...
        <div class="w-full max-w-md bg-white border border-gray-200 rounded-lg shadow-sm">
            ...
            <div class="p-8">
                <div class="mb-6">
                    ...
                    <p class="text-lg text-gray-800 font-medium">{{ $eps->Denominacion }}</p>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <p class="text-gray-600 text-sm leading-relaxed">
                        {{ $eps->Observaciones ?? 'No se proporcionó una descripción para este registro.' }}
                    </p>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4 pt-4 border-t border-gray-100">
                    <div>
                        <label class="block text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-1">ID
                            Registro</label>
                        <p class="text-sm font-mono text-gray-500">{{ $eps->Numdoc }}</p>
                    </div>
            ...
            <div class="bg-gray-50 px-8 py-4 rounded-b-lg border-t border-gray-100 flex justify-between items-center">
                <span class="text-xs text-gray-500">ID del programa: <strong>{{$eps->NIS}}</strong></span>
