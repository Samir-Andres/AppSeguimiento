...
<div class="container">
    ...
    <div class="content">
        ...
        <p>Te escribimos para informarte que se has sido seleccionado en el sistema para dar seguimientos al siguiente programa </p>
        <p>Programa para seguimientos: {{ $programa->Denominacion }}</p>
        <p>Ficha para seguimientos: {{ $ficha->Denominacion }}</p>
        ...
        <p style="margin-top: 5px;">Nombre: {{ $instructor->Nombres }} {{$instructor->Apellidos}}</p>
        <p style="margin-top: 5px;">Correo: {{ $instructor->Correo_Institucional }}</p>
