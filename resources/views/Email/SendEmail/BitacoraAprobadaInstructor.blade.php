...
<div class="container">
    ...
    <div class="content">
        <h2>Instructor</h2>
        <p>Te escribimos para informarte que has aprobado la bitácora del aprendiz {{$aprendiz->Nombres }} {{ $aprendiz->Apellidos }}, de la ficha {{$ficha->Denominacion}} satisfactoriamente </p>
