            ...
            <div class="container-fluid px-4 py-6">
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                    ...
                    <div class="bg-gradient-to-r from-indigo-500 to-purple-600 px-8 py-8 text-center">
                        ...
                        <h1 class="text-2xl font-bold text-white">{{ $instructor->Nombres }} {{ $instructor->Apellidos }}</h1>
                        <p class="text-indigo-100 text-xs mt-1">NIS: {{ $instructor->NIS }}</p>
                    </div>

                    <!-- Card body -->
                    <div class="px-20 py-8">

                        <form action="{{ route('perfil.instructor-update',  $instructor->NIS) }}" method="POST"
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center h-10 pl-3 border border-slate-200 bg-gray-50 rounded-full overflow-hidden">
                                        ...
                                        <input type="text" value="{{ $instructor->Nombres }}"
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center h-10 pl-3 border border-slate-200 bg-gray-50 rounded-full overflow-hidden">
                                        <i class="fas fa-user text-slate-400 text-xs"></i>
                                        <input type="text" value="{{ $instructor->Apellidos }}"
                                               class="h-full px-2 w-full outline-none bg-transparent text-gray-400"
                                               disabled>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center h-10 pl-3 border border-slate-200 bg-gray-50 rounded-full overflow-hidden">
                                        ...
                                        <input type="text" value="{{ $instructor->Numdoc }}"
                                               class="h-full px-2 w-full outline-none bg-transparent text-gray-400"
                                               disabled>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center h-10 pl-3 border border-slate-200 bg-gray-50 rounded-full overflow-hidden">
                                        ...
                                        <input type="text" value="{{ \Carbon\Carbon::parse($instructor->FechaNac)->format('d/m/Y') }}"
                                               class="h-full px-2 w-full outline-none bg-transparent text-gray-400"
                                               disabled>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center h-10 pl-3 border border-slate-200 bg-gray-50 rounded-full overflow-hidden">
                                        ...
                                        <input type="text" value="{{ $instructor->Sexo == 0 ? 'Masculino' : 'Femenino' }}"
                                               class="h-full px-2 w-full outline-none bg-transparent text-gray-400"
                                               disabled>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center h-10 pl-3 border border-slate-200 bg-gray-50 rounded-full overflow-hidden">
                                        ...
                                        <input type="text" value="{{ $instructor->Correo_Institucional }}"
                                               class="h-full px-2 w-full outline-none bg-transparent text-gray-400"
                                               disabled>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center h-10 pl-3 border border-slate-300 rounded-full focus-within:ring-2 focus-within:ring-indigo-400 transition-all overflow-hidden @error('Correo_Personal') border-red-400 @enderror">
                                        ...
                                        <input type="email"
                                               ...
                                               value="{{ old('Correo_Personal', $instructor->Correo_Personal) }}"
                                               class="h-full px-2 w-full outline-none bg-transparent"
                    ...
                    <div class="bg-gray-50 border-t border-gray-100 px-8 py-4 text-center">
                        <p class="text-xs text-gray-400">
                            ...
                            <a href="{{ route('perfil.edit', $instructor->users_id) }}" class="text-indigo-500 hover:underline font-medium">
                                Clic aquí
                            </a>
                        </p>
                    </div>
