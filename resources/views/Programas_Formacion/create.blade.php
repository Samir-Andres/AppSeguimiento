...
@section('content_header')
    <div class="flex flex-wrap  items-center space-x-2 text-sm text-gray-500 font-medium">
        ...
        <a class="text-indigo-500">Crear programa</a>
...
@section('content')
    ...
    <form action="{{route('Programas.store')}}" class="flex flex-col items-center text-sm text-slate-800" method="POST">
        @csrf
         <h1 class="text-4xl font-bold py-4 text-center">Crear Programas</h1>
        ...
        <div class="max-w-96 w-full px-4">
            ...
            <div class="flex items-center mt-2 mb-2 h-10 pl-3 border border-slate-300 rounded-full focus-within:ring-2 focus-within:ring-indigo-400 transition-all overflow-hidden">
                <input type="text" name="Codigo" class="h-full px-2 w-full outline-none bg-transparent" placeholder="Codigo" value="{{old('Codigo')}}" >
