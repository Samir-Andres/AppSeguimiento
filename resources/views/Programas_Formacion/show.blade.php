...
@section('content_header')
    ...
    <div class="flex flex-wrap  items-center space-x-2 text-sm text-gray-500 font-medium">
        ...
        <a href="{{ route('Alternativa.Index') }}">Programas formación</a>
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                d="m14.413 10.663-6.25 6.25a.939.939 0 1 1-1.328-1.328L12.42 10 6.836 4.413a.939.939 0 1 1 1.328-1.328l6.25 6.25a.94.94 0 0 1-.001 1.328"
                fill="#CBD5E1" />
        </svg>
        <a class="text-indigo-500">Detalle de programas</a>
        ...
        <div class="w-full max-w-md bg-white border border-gray-200 rounded-lg shadow-sm">
            ...
            <div class="p-8">
                <div class="mb-6">
                    ...
                    <p class="text-lg text-gray-800 font-medium">{{ $programa->Denominacion }}</p>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <p class="text-gray-600 text-sm leading-relaxed">
                        {{ $programa->Observaciones ?? 'No se proporcionó una descripción para este registro.' }}
                    </p>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4 pt-4 border-t border-gray-100">
                    <div>
                        <label class="block text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-1">ID
                            Registro</label>
                        <p class="text-sm font-mono text-gray-500">{{ $programa->NIS }}</p>
                    </div>
                </div>
            </div>

            <!-- Footer discreto -->
            <div class=" text-center bg-gray-50 px-8 py-4 rounded-b-lg border-t border-gray-100 flex justify-between items-center">
                 <a href="{{ url()->previous() }}" class="text-xs text-center font-semibold text-blue-600 hover:underline">
                    Regresar
                </a>
            </div>
        </div>
