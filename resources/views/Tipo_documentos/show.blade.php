...
@section('title', 'Detalle del tipo')
...
@section('content_header')
    ...
    <div class="flex flex-wrap  items-center space-x-2 text-sm text-gray-500 font-medium">
        ...
        <a class="text-indigo-500">Detalle del tipo de documento</a>
        ...
        <div class="w-full max-w-md bg-white border border-gray-200 rounded-lg shadow-sm">
            ...
            <div class="p-8 grid grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <p class="text-gray-600 text-sm leading-relaxed">
                        @if ($tipo->Observaciones)
                            <span class="text-gray-600 font-medium">{{ $tipo->Observaciones }}</span>
                        @else
                ...
                <div class="col-span-2 pt-4 border-t border-gray-100">
                    ...
                    <p class="text-sm font-mono text-gray-500">{{ $tipo->NIS }}</p>
                </div>
