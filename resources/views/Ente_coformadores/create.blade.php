...
@section('title', 'Crear ente coformador')
...
@section('content_header')
    <div class="flex flex-wrap  items-center space-x-2 text-sm text-gray-500 font-medium ">
        ...
        <a class="text-indigo-500">Registrar ente</a>
                ...
                <form method="POST" action="{{route('Entecoformadores.store')}}">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-2">
                        ...
                        <div>
                            ...
                            <input type="number" name="Numdoc" placeholder="1029..." class="w-full px-3 py-2.5 border border-gray-200 rounded-xl text-sm outline-none focus:border-indigo-500 transition-colors" value="{{ old('Numdoc') }}" />
                            @error('Numdoc')
                            <p class="text-red-500 text-xs mb-0 pl-2 text-center">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="Razon_Social" placeholder="institución autorizada" class="w-full px-3 py-2.5 border border-gray-200 rounded-xl text-sm outline-none focus:border-indigo-500 transition-colors" value="{{ old('Razon_Social') }}" />
                            @error('Razon_Social')
                            <p class="text-red-500 text-xs mb-0 pl-2 text-center">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="Direccion" placeholder="Calle #11" class="w-full px-3 py-2.5 border border-gray-200 rounded-xl text-sm outline-none focus:border-indigo-500 transition-colors" value="{{ old('Direccion') }}" />
                            @error('Direccion')
                            <p class="text-red-500 text-xs mb-0 pl-2 text-center">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="Correo_Institucional" placeholder="institucion@gmail.com" class="w-full px-3 py-2.5 border border-gray-200 rounded-xl text-sm outline-none focus:border-indigo-500 transition-colors text-gray-500 " value="{{ old('Correo_Institucional') }}" />
                    ...
                    <div class="flex justify-center items-center w-50 mt-0">
                        <button type="submit"
